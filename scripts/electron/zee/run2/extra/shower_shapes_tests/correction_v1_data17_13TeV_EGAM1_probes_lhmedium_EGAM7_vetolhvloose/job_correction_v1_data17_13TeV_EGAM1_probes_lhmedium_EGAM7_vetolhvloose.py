...
# Install ringer v1
from TrigEgammaEmulationTool import installZeeSSL2CaloRingerSelector_v1
...
targets = [
            Target( 'L2_Tight_v1' , 'T0HLTElectronSSRingerTight_v1' , "T0HLTElectronSSRingerTight_v1"  ) , 
            Target( 'L2_Medium_v1', 'T0HLTElectronSSRingerTight_v1' , "T0HLTElectronSSRingerMedium_v1" ) ,
            Target( 'L2_Loose_v1' , 'T0HLTElectronSSRingerTight_v1' , "T0HLTElectronSSRingerLoose_v1"  ) ,
            Target( 'L2_VLoose_v1', 'T0HLTElectronSSRingerTight_v1' , "T0HLTElectronSSRingerVeryLoose_v1" ) ,
          ]
...
etbins  = [15.0, 20.0, 30.0, 40.0, 50.0, 10000000]
