...
# Install ringer low energy v1
from RingerSelectorTools import installElectronL2CaloRingerSelector_v1
...
targets = [
            Target( 'L2_Tight' , 'T0HLTElectronRingerTight_v1' , "T0HLTElectronT2CaloTight"  ) , 
            Target( 'L2_Medium', 'T0HLTElectronRingerTight_v1' , "T0HLTElectronT2CaloMedium" ) ,
            Target( 'L2_Loose' , 'T0HLTElectronRingerTight_v1' , "T0HLTElectronT2CaloLoose"  ) ,
            Target( 'L2_VLoose', 'T0HLTElectronRingerTight_v1' , "T0HLTElectronT2CaloVLoose" ) ,
          ]
...
alg.setHistogram2DRegion( -7, 5, 0, 100, 0.02, 0.5 )
