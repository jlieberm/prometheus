prun \
     --exec \
       "sh -c '. /setup_envs.sh && python \$HOME/prometheus/analysis/phd/run2/extra/v10/efficiency_v10_data17_13TeV_EGAM1_probes_lhmedium/job_efficiency_v10_data17_13TeV_EGAM1_probes_lhmedium.py -i %IN -o output.root';" \
     ...
     --outDS=user.jodafons.test_prot_eff_after_ts1.r12 \
     --disableAutoRetry \
     --outputs="output:*.root" \
     --nFilesPerJob=1 \
