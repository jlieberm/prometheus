...
targets = [
            ...
            Target( 'L2_Medium', 'T0HLTElectronRingerTight_v5' , "T0HLTElectronT2CaloMedium" ) ,
            Target( 'L2_Loose' , 'T0HLTElectronRingerTight_v5' , "T0HLTElectronT2CaloLoose"  ) ,
            Target( 'L2_VLoose', 'T0HLTElectronRingerTight_v5' , "T0HLTElectronT2CaloVLoose" ) ,
          ]
