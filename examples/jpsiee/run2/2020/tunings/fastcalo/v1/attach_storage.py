...
if args.name == 'lps':
  ...
  path2 = '/home/asp-calo/jodafons/phd_data/analysis/run2/extra/low_energy'
  path3 = '/home/asp-calo/jodafons/tuning_data'
elif args.name == 'castor':
  path1 = '/Volumes/castor/cern_data'
  path2 = '/Volumes/castor/phd_data/analysis/run2/extra/low_energy'
  path3 = '/Volumes/castor/tuning_data'
elif args.name == 'cern':
  path1 = '/eos/user/j/jodafons/cern_data'
  path2 = '/eos/user/j/jodafons/phd_data/analysis/run2/extra/low_energy'
