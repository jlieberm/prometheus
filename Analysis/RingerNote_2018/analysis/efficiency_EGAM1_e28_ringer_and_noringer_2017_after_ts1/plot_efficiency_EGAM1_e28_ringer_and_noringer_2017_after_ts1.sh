...
plot_groups.py  -t $DATA_2017_AFTER_TS1 \
                ...
                -o 'plot_efficiency_EGAM1_e28_ringer_and_noringer_2017_after_ts1' \
                --pdf_output 'plot_efficiency_EGAM1_e28_ringer_and_noringer_2017_after_ts1.pdf' \
                --pdf_title 'Monitoring 2017 With/Without Ringer (EGAM1, After TS1)'
