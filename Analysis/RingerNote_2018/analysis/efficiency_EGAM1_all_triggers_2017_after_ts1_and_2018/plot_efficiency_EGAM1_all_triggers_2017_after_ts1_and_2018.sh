...
DATA_2018="cern_data/data18_13TeV/Mon/EGAM1_merged/"
RUNLABEL="Data 2017, 2018, #sqrt{s}=13 TeV"

plot_triggers.py -d cern_data/data17_13TeV/Mon/EGAM1/after_ts1 cern_data/data18_13TeV/Mon/EGAM1_merged \
                --triggers $TRIGGERS \
