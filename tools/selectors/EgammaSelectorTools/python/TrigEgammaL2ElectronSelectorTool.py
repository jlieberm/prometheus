...
class TrigEgammaL2ElectronSelectorTool( Algorithm ):
  ...
  def __init__(self, name, **kw):
    ...
    self._calotrackdeta           =  retrieve_kw( kw, 'CaloTrackdETA'        ,   0.2   )
    self._calotrackdphi           =  retrieve_kw( kw, 'CaloTrackdPHI'        ,   0.3   )
    self._calotrackdeoverp_low    =  retrieve_kw( kw, 'CaloTrackdEoverPLow'  ,   0     )
    self._calotrackdeoverp_high   =  retrieve_kw( kw, 'CaloTrackdEoverPHigh' ,   999   )
    self._trtratio                =  retrieve_kw( kw, 'TRTRatio'             ,   -999  )
