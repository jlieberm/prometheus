...
class Chain( Algorithm ):
  ...
  def __init__(self, name, **kw):
    ...
    self._efcaloEtCut  = retrieve_kw( kw, 'EDCaloEtCut', 0 )
  ...
  def accept( self, context ):
    ...
    em = self.getHandler("HLT__FastCaloContainer")
    if  not ( ( em.et() > self._l2caloEtCut*GeV ) bool(dec.accept( self._l2caloItem )) ):
      return accept
    ...
    passedL2 = bool(dec.accept( self.l2Item ))
    ...
    clCont = self.getHandler( "HLT__CaloClusterContainer" )
